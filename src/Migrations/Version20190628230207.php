 ...
 */
final class Version20190628230207 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE campaign CHANGE name author VARCHAR(150) DEFAULT \'NULL\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE campaign CHANGE author name VARCHAR(150) DEFAULT \'NULL\' COLLATE utf8_general_ci');
